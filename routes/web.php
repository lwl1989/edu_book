...
Route::group(['prefix' => 'teacher', 'middleware' => ['format']], function () {
    ...
    Route::post('receive', 'Actions\TeacherController@doReceive');
    Route::get('received', 'Actions\TeacherController@received');
    Route::get('get/received', 'Actions\TeacherController@getBookHasReceived');
